...
def load_config() -> AppConfig:
    ...
    if "models" in file_data:
        ...
        return AppConfig(models=models, main_model_id=main_id, fast_model_id=fast_id, api_key=api_key, agents=agents, tools=tools, sandbox=sandbox, disabled_skills=disabled_skills, mcp_servers=mcp_servers)
